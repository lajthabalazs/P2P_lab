...
public class SignalingMessage extends BasicMessage {
	 ...
	 */
	public static SignalingMessage createJoinMessage(PeerDescriptor source) {
		SignalingMessage message = new SignalingMessage();
		message.setType(JOIN_TYPE);
	...
	/**
	 * Creates a message containing the information of the neighboring peer
